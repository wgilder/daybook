...
if [ -e /debug1 ]; then
	...
	echo "Running app in production mode!"
        newrelic-admin generate-config 3fb0b685cf662997a4856f7d9b61427553d9505e newrelic.ini
	nginx && NEW_RELIC_CONFIG_FILE=newrelic.ini newrelic-admin run-program uwsgi --ini /app.ini
fi
